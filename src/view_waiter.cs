...
lb_status = new Label();
lb_status.Size = new Size(280, 30);
lb_status.Location = new Point(20, 20);
this.Controls.Add(lb_status);

pb_percentage = new ProgressBar();
pb_percentage.Size = new Size(265, 30);
pb_percentage.Location = new Point(20, 60);
...
btn_cancel.Size = new Size(265, 30);
btn_cancel.Location = new Point(20, 100);
